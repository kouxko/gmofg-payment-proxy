...
use crate::{
    ...
    MAX_SOCKET_MAXIMUM_CONNECTIONS, ProxyListener, SocketDownstreamTlsSettings,
...
fn validate_socket_downstream_tls(
    ...
    validate_existing_reference(
        ...
        certificate_ids,
        certificate_kinds,
        format!("{prefix}.security.downstream_tls.server_identity"),
    ...
    validate_client_authentication(
        ...
        certificate_ids,
        certificate_kinds,
        format!("{prefix}.security.downstream_tls.client_authentication"),
        error,
    );
}
...
fn validate_socket_upstream_tls(
    ...
    validate_upstream_tls_references(
        ...
        certificate_ids,
        certificate_kinds,
        &format!("{prefix}.security.upstream_tls"),
        error,
    );
}
