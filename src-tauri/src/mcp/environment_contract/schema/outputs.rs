...
#[rustfmt::skip]
fn preview() -> Value { json!({"type":"object","additionalProperties":false,"required":["target_key","target","baseline_public","validation_layers","resources","alias_graph","materials_public","protocol_document_values","terminal_action_fields"],"properties":{"target_key":{"type":"string"},"target":{"oneOf":[{"type":"object","additionalProperties":false,"required":["mode","workspace_id","expected_revision"],"properties":{"mode":{"const":"existing"},"workspace_id":{"type":"string","format":"uuid"},"expected_revision":{"type":"integer","minimum":0}}},{"type":"object","additionalProperties":false,"required":["mode","name"],"properties":{"mode":{"const":"new"},"name":{"type":"string"}}}]},"baseline_public":{"type":"object","additionalProperties":false,"required":["workspace_id","revision","selected"],"properties":{"workspace_id":{"type":["string","null"]},"revision":{"type":["integer","null"],"minimum":0},"selected":{"type":"boolean"}}},"resources":{"type":"object","additionalProperties":false,"required":["listeners","rules","android_profile_ids"],"properties":{"listeners":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["alias","candidate_local_id"],"properties":{"alias":{"type":"string"},"candidate_local_id":{"type":"string","format":"uuid"}}}},"rules":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["candidate_index","candidate_local_id","created_order","listener_alias"],"properties":{"candidate_index":{"type":"integer","minimum":0},"candidate_local_id":{"type":"string","format":"uuid"},"created_order":{"type":"integer","minimum":0},"listener_alias":{"type":"string"}}}},"android_profile_ids":{"type":"array","items":{"type":"string"}}}},"alias_graph":{"type":"object","additionalProperties":false,"required":["certificate_aliases","secret_aliases"],"properties":{"certificate_aliases":{"type":"array","items":{"type":"string"}},"secret_aliases":{"type":"array","items":{"type":"string"}}}},"materials_public":{"type":"object","additionalProperties":false,"required":["certificates","secrets"],"properties":{"certificates":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["alias","role","encoding","label"],"properties":{"alias":{"type":"string"},"role":{"enum":["downstream_server_identity","downstream_client_trust","upstream_client_identity","upstream_server_trust"]},"encoding":{"enum":["pem","base64_der","pkcs12_base64"]},"label":{"type":"string"}}}},"secrets":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["alias","role","username","label"],"properties":{"alias":{"type":"string"},"role":{"const":"proxy_basic_auth"},"username":{"type":"string"},"label":{"type":"string"}}}}}},"protocol_document_values":{"type":"array","items":{"$ref":"#/$defs/jsonValue"}},"terminal_action_fields":{"type":"object","additionalProperties":false,"required":["TruncateResponse","DisconnectDuringUpstreamWrite","DisconnectDuringDownstreamWrite"],"properties":{"TruncateResponse":{"const":["bytes"]},"DisconnectDuringUpstreamWrite":{"const":["after_bytes"]},"DisconnectDuringDownstreamWrite":{"const":["after_bytes"]}}},"validation_layers":{"type":"array","items":{"$ref":"#/$defs/validationLayer"}}}}) }
