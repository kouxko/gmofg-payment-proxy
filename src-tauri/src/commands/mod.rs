...
pub fn builder() -> Builder<Wry> {
    ...
    Builder::<Wry>::new()
        ...
        .commands(collect_commands![
            ...
            rule_editor_context,
            rule_definition_get,
            rule_definition_copy,
            rule_definition_http_condition_draft,
            rule_definition_action_draft,
            rule_definition_document_condition_draft,
            rule_definition_document_action_draft,
            rule_definition_document_common_action_draft,
            rule_definition_create_from_exchange_observation,
            rule_parse_document_value,
