...
export const pageHelpGuides: Record<WorkspacePath, PageHelpGuide> = {
  ...
  "/sessions": {
    title: "会话记录",
    summary:
      "查询 Rust 内存中限量保留的完整请求会话，并按需查看 Payload 与规则轨迹。",
    recommendedFor:
    ...
    sections: [
      {
        ...
        steps: [
          ...
          "列表数量受系统设置中的会话条数和内存上限共同约束；达到上限后，Rust 自动淘汰最旧的已完成会话。",
        ],
      },
      {
        id: "sessions-detail",
        title: "查看会话详情",
        steps: [
          "选择表格中的会话会直接打开全尺寸详情弹窗；关闭后释放前端 Payload 引用，再次点击该行即可重新打开。",
      ...
      },
      {
        ...
        title: "容量和自动淘汰",
        steps: [
          "会话只保存在 Rust 内存中，条数上限和共享内存上限可在“设置”中查看和调整。",
          "任一容量达到上限时，Rust 优先淘汰最旧的已完成会话，并同步从列表中移除。",
